...
private slots:
  ...
  void on_action_view_toggle_snapToGrid_triggered();
  void on_action_view_toggle_showGrid_triggered();
  void on_action_view_toggle_showLocations_triggered();
  void on_action_view_cleanMap_triggered();
  void on_action_view_toggle_showUnitSize_triggered();
  void on_action_view_toggle_showBuildingSize_triggered();
  void on_action_view_toggle_showSightRange_triggered();
  void on_action_view_toggle_showSeekAttackRange_triggered();
  void on_action_view_toggle_showCreep_triggered();
  void on_action_view_toggle_showPylonAura_triggered();
  void on_action_view_toggle_showAddonNydusLinkage_triggered();
  void on_action_view_toggle_showCollisions_triggered();
